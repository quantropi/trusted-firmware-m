...
def wrap(sign_tool, align, version, header_size, layout, infile, outfile, measured_boot_record, encrypt):
    ...
    print("args:", sign_tool, align, version, header_size, layout, encrypt, infile, outfile, measured_boot_record, encrypt)
    ...
    if record_sw_type is not None:
        cmd = "{}/qtpsign -v {} -t b_u585i_iot02a -s {} -h {} -a {} -k {}/sbl_certs/qghppkds1/customer.key -c {}/sbl_certs/qghppkds1/customer.crt -i {} -o {} -b {}".format(sign_tool, version, slot_size, header_size, align, sign_tool, sign_tool, infile, outfile, record_sw_type)
    else:
